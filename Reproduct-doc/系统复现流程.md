...
## 00 环境配置-虚拟机part
### 版本：
1. 使用 **virtual box** 虚拟机，现在的版本是：**7.0.6版本**
2. 在 virtual box 里配置虚拟机环境， **ubuntu** 版本是：**22.04版本**
3. 安装环境
...
- 进入[go官网下载页面](https://golang.google.cn/dl/)，下载go语言环境，对于一般linux设备应该下载名如`go1.13.9.linux-amd64.tar.gz`的文件
