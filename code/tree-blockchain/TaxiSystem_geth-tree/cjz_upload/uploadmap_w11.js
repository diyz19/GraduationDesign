...
MyContract.setProvider(new Web3.providers.HttpProvider("http://localhost:8511"));

// contract address 
var myContractInstance = MyContract.at("0x92d9f82c71009d41798ff50b30062e32af6fbe48");
var account = "0x456c4df0610c7611ae8bcaed32dd1d94e88ceca4";
...
async function add_area_line(geohash, gid, gas, retry_times) {
	...
	await myContractInstance.add_area_line(geohash, gid, { from: account, gas: gas, position: "w1111111111111", txtime: 278000 }).then(function (result) {
		// console.log(result);
	},
		function (err) {
...
async function add_oneline(gid, minzoom, cost, source, target, oneway, building, highway, name, gtype, path, gas, retry_times) {
	...
	await myContractInstance.add_onetype(gid, minzoom, cost, source, target, oneway, building, highway, name, gtype, path, { from: account, gas: gas, position: "w1111111111111", txtime: 278000 }).then(function (result) {
		console.log("gid: ", gid);
