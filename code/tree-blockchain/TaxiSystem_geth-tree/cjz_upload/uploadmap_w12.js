...
MyContract.setProvider(new Web3.providers.HttpProvider("http://localhost:8521"));

// contract address 
var myContractInstance = MyContract.at("0x2d52ddd4ada5041f1f52bbbdb66d661aea96d491");
var account = "0x1dee886dee470f8e725c27061b55ad7e8619d92a";
...
async function add_area_line(geohash, gid, gas, retry_times) {
	...
	await myContractInstance.add_area_line(geohash, gid, { from: account, gas: gas, position: "w1211111111111", txtime: 278000 }).then(function (result) {
		// console.log(result);
	},
		function (err) {
...
async function add_oneline(gid, minzoom, cost, source, target, oneway, building, highway, name, gtype, path, gas, retry_times) {
	...
	await myContractInstance.add_onetype(gid, minzoom, cost, source, target, oneway, building, highway, name, gtype, path, { from: account, gas: gas, position: "w1211111111111", txtime: 278000 }).then(function (result) {
		console.log("gid: ", gid);
